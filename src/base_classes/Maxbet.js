...
export default class Maxbet {
    ...
    addMaxbet() {
        this.maxBet = new Sprite(this.scene, Config.width - 477, Config.height - 50, 'button', 'button.png');
        ...
        holder.fillRect(Config.width - 565, Config.height - 150, 160, 60);
